...
if submit_btn:
    if not nama or not no_hp or not nama_bisnis or not deskripsi:
        ...
        # Prompt yang disesuaikan dengan instruksi baru
        prompt = (
            ...
            " Jawab RINGKAS, INSPIRATIF, dan Maksimal 1-2 kalimat per poin!\n\n"
            "🎯 **Potensi Bisnis**: Pilih salah satu dari kategori ini -> [Sangat Menjanjikan / Prospek Baik / Cukup Baik] - [1 kalimat kesimpulan alasantya]\n\n"
            "💡 **Keunikan Produk yang Bisa Digali**: [1-2 kalimat ide inovasi/nilai tambah unik dari produk ini agar tampil beda di pasaran]\n\n"
